...
* Update CHANGELOG.md on main through 7.40.0 ([#12694](https://github.com/hashicorp/terraform-provider-google-beta/pull/12694))
* build(deps): bump golang.org/x/crypto from 0.50.0 to 0.52.0 in /tools/go-changelog ([#12719](https://github.com/hashicorp/terraform-provider-google-beta/pull/12719))
* fixed incorrect resource addition in changelogs ([#12695](https://github.com/hashicorp/terraform-provider-google-beta/pull/12695))
...
* **New Resource:** `google_compute_router_named_set` (GA promotion) ([#12688](https://github.com/hashicorp/terraform-provider-google-beta/pull/12688))
...
* **New Resource:** chronicle: `google_chronicle_environment_group` (GA) ([#12697](https://github.com/hashicorp/terraform-provider-google-beta/pull/12697))
...
* backupdr: added `backup_blocked_by_vault_access_restriction` to `data.google_backup_dr_data_source` ([#12717](https://github.com/hashicorp/terraform-provider-google-beta/pull/12717))
* backupdr: added `force_update_access_restriction` to `google_backup_dr_backup_vault` ([#12717](https://github.com/hashicorp/terraform-provider-google-beta/pull/12717))
* backupdr: added update support for `access_restriction` to `google_backup_dr_backup_vault` ([#12717](https://github.com/hashicorp/terraform-provider-google-beta/pull/12717))
...
* compute: added `FLEX_START` and `RESERVATION_BOUND` support to `google_compute_instance`, `google_compute_instance_template`, and `google_compute_region_instance_template` ([#12720](https://github.com/hashicorp/terraform-provider-google-beta/pull/12720))
...
* discoveryengine: added `enable_llm_layout_parsing` and `enable_get_processed_document` fields to `google_discovery_engine_data_store` ([#12675](https://github.com/hashicorp/terraform-provider-google-beta/pull/12675))
...
* sql: added `include_replicas_for_major_version_upgrade` field to `google_sql_database_instance` ([#12702](https://github.com/hashicorp/terraform-provider-google-beta/pull/12702))
* sql: added `switch_transaction_logs_to_cloud_storage_enabled` field to `google_sql_database_instance` ([#12686](https://github.com/hashicorp/terraform-provider-google-beta/pull/12686))
...
* vertexai: promoted `google_vertex_ai_semantic_governance_policy_engine` to GA ([#12704](https://github.com/hashicorp/terraform-provider-google-beta/pull/12704))
...
* workbench: added support for `min_cpu_platform` in `google_workbench_instance` ([#12723](https://github.com/hashicorp/terraform-provider-google-beta/pull/12723))
